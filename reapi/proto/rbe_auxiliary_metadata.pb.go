...
var file_rbe_auxiliary_metadata_proto_goTypes = []interface{}{
...
func file_rbe_auxiliary_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_rbe_auxiliary_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rbe_auxiliary_metadata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rbe_auxiliary_metadata_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuxiliaryMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
