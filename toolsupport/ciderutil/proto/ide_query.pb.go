...
func file_ide_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ide_query_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_ide_query_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_ide_query_proto_msgTypes[8].OneofWrappers = []interface{}{}
	file_ide_query_proto_msgTypes[9].OneofWrappers = []interface{}{}
	type x struct{}
